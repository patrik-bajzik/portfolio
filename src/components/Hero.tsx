  ...
  return (
    <section id="top" className="relative min-h-screen overflow-hidden pt-32 pb-20">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div
          className="absolute left-1/2 top-0 h-[500px] w-[800px] -translate-x-1/2 rounded-full bg-accent/10 blur-[120px] animate-glow-pulse"/>
      ...
      <div className="mx-auto max-w-6xl px-5">
        <div className="flex flex-col items-center text-center">
          ...
          <h1
            className="animate-fade-up text-balance text-5xl font-semibold leading-[1.05] tracking-tight sm:text-6xl md:text-7xl lg:text-[5.5rem]">
          ...
          >
            <a
              href="#work"
              className={`inline-flex items-center gap-2 rounded-full border border-border overflow-hidden`
                + ` bg-surface-2/40 px-6 py-3 text-sm font-medium text-content-muted transition-all`
                + ` hover:border-border-strong hover:bg-surface-hover hover:text-content-strong`}
            >
