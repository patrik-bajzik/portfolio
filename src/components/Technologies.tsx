    ...
    <section id="stack" className="relative py-28 sm:py-36">
      <div className="mx-auto max-w-6xl px-5">
        <div ref={ref} className={`reveal ${visible ? 'is-visible' : ''}`}>
          ...
          <h2
            className="mt-10 max-w-2xl text-balance text-3xl font-semibold leading-tight tracking-tight text-content-strong sm:text-4xl md:text-5xl">
            {t('tech.title')}{' '}
              ...
              return (
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <h3 className="mt-5 text-sm font-medium text-content-strong xss:text-base">{tech.name}</h3>
                    <p className="mt-1.5 text-xs hyphens-auto break-words leading-relaxed text-content-faint xss:text-sm">{t(tech.descKey)}</p>
                  </div>
                </div>
              );
            })}
