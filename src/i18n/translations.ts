...
export const translations = {
  sk: {
    ...
    'projects.qnslide_web.blurb': 'Web frontend pre QnSlide — modernú platformu na prezentácie. Postavený s React, TypeScript a Tailwind, so zameraním na plynulý zážitok úpravy slajdov v reálnom čase.',
    'projects.qnslide_platform.blurb': 'Backend platforma poháňajúca QnSlide — Node.js a TypeScript API s PostgreSQL, kontajnerizované s Docker. Spracuje autentifikáciu, perzistenciu a real-time kolaboráciu.',
    'projects.todo_list_mern.blurb': 'Full-stack to-do list aplikácia postavená na MERN stacku. CRUD operácie, autentifikácia používateľov a čisté, responzívne UI.',
    'projects.roadmap_backend.blurb': 'REST API pre platformu vzdelávacích ciest, postavené s Node.js a Express. Štruktúrované endpointy, validácia a čisté spracovanie chýb.',
    'projects.code': 'Kód',
    'projects.demo': 'Živé demo',
    'projects.status.active': 'Pracujem',
    'projects.status.completed': 'Dokončené',
  ...
  en: {
    ...
    'projects.qnslide_web.blurb': 'Interactive web client for QnSlide platform, focused on live question slides and audience engagement.',
    'projects.qnslide_platform.blurb': 'Core platform for managing interactive question sessions, slides and real-time communication.',
    'projects.todo_list_mern.blurb': 'Full-stack To-do List app built with the MERN stack. Includes authentication, responsive UI and deployment on Render, Vercel and MongoDB Atlas.',
    'projects.roadmap_backend.blurb': 'Backend service powering roadmap features, APIs and data layer for project planning.',
    'projects.code': 'Code',
    'projects.demo': 'Live demo',
    'projects.status.active': 'Working',
